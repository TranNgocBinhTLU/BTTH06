...
function clock(){
    ...
    if(h<10){
        hours[0].src=`imgs/00.gif`
        hours[1].src=`imgs/0${h}.gif`
    }
    else{
        hours[0].src=`imgs/0${Math.floor(h/10)}.gif`
        hours[1].src=`imgs/0${h%10}.gif`
    }
    
    if(m<10){
        minutes[0].src=`imgs/00.gif`
        minutes[1].src=`imgs/0${m}.gif`
    }
    else{
        minutes[0].src=`imgs/0${Math.floor(m/10)}.gif`
        minutes[1].src=`imgs/0${m%10}.gif`
    }
    if(s<10){
        seconds[0].src=`imgs/0${Math.floor(s/10)}.gif`
        seconds[1].src=`imgs/0${s%10}.gif`
    }
    else{
        seconds[0].src=`imgs/0${Math.floor(s/10)}.gif`
        seconds[1].src=`imgs/0${s%10}.gif`
